export const about = {
  title: "About Wood Away Guide Site",
  subtitle: "Player Community & Game Resources",
  content: {
    mission: {
      title: "Our Mission",
      text: "Our mission is simple: to create the most helpful, accurate, and user-friendly resource for Wood Away players. Whether you're stuck on a particularly challenging puzzle or just want to learn clearing techniques, we're here to help.",
    },
    values: {
      title: "Core Values",
      items: [
...
export const privacy = {
  ...
  content: {
    introduction: {
      title: "Introduction",
      text: "This Privacy Policy explains how Wood Away Guide Site collects, uses, and protects your personal information. By using our services, you agree to the terms of this Privacy Policy.",
    },
    dataCollection: {
...
export const termsOfService = {
  ...
  content: {
    introduction: {
      title: "Introduction",
      text: "Welcome to Wood Away Guide Site, a fan-made website dedicated to providing walkthroughs and guides for the Wood Away game. By accessing or using our website, you agree to be bound by these Terms of Service.",
    },
    disclaimer: {
      title: "Disclaimer",
      text: "Wood Away Guide Site is not affiliated with, endorsed by, or in any way officially connected with the official Wood Away game or its developers. All game content, images, and trademarks are property of their respective owners.",
    },
    userConduct: {
      title: "User Conduct",
